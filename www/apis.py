...
class Page(object):
	...
	def __str__(self):
		return 'item_count: %s, page_count: %s, page_index, page_size: %s, offset: %s, limit: %s' % (self.item_count, self.page_count, self.page_index, self.page_size, self.offset, self.limit)
